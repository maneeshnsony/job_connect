  ...
  if (data.length === 0) {
    return (
      <div className="rounded-xl border p-12 text-center" style={{ background: 'var(--bg-card)', borderColor: 'var(--border)' }}>
        ...
        <h3 className="text-lg font-medium" style={{ color: 'var(--text-secondary)' }}>No outreach records yet</h3>
        <p className="text-sm mt-1" style={{ color: 'var(--text-muted)' }}>Click "Add New" to create your first record.</p>
      </div>
    );
  }
